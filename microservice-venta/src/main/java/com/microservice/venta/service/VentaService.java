...
public class VentaService {
    ...
    public VentaDto create (ListProductoDto listProductoDto, String authentication) throws JRException {
        ...
        Venta venta3 = ventaRepository.save(venta2);


        return VentaDto.builder()
                .Id(venta3.getId())
                .total(venta3.getTotal())
                .iva(venta3.getIva())
                .totalConIVA(venta3.getTotalConIVA())
                .inventarioId(venta3.getInventarioId())
                .build();
    ...
    public ResponseEntity<FileSystemResource> findFilePdf(Long number, String authentication){
